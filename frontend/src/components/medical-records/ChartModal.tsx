...
export default function ChartModal({
  ...
  const [surgeryImagePreview, setSurgeryImagePreview] = useState<string | null>(
    null
  );
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-400"
                        placeholder="예: 혈액 검사"
                      />
                    </div>
                    <div>
            ...
            {!showSurgery ? (
              ...
              <div className="space-y-2 bg-gray-50 rounded p-4 mt-2">
                ...
                <div>
                  ...
                  <textarea
                    value={surgeryResult}
                    onChange={(e) => setSurgeryResult(e.target.value)}
                    className="w-full bg-white border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-400"
                  />
                </div>
                <div>
